...
const HeroFullScreen = () => {
  ...
  const scrollToContent = () => {
    const featureCardsElement = document.getElementById('funcionalidades');
  ...
  return (
    <section className="h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50/30 via-white to-indigo-50/20 dark:from-slate-900/30 dark:via-background dark:to-slate-800/20 pt-16 md:pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Botão CTA CORRIGIDO */}
        <div className={`mb-16 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className={`absolute bottom-10 left-1/2 -translate-x-1/2 transform transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <button 
