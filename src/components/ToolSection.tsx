...
import { MessageSquare, Calculator, Search, Package, ArrowRight, Play, Check, Zap } from 'lucide-react';
import { Dialog, DialogTrigger } from "@/components/ui/dialog";
import { Button } from '@/components/ui/button';
import ToolDetailModal from './ToolDetailModal'; // Importando o novo componente de modal
          ...
          <div className={`${isEven ? 'lg:order-2' : 'lg:order-1'} px-4 lg:px-0`}>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                 {/* BOTÃO "Ver em ação" permanece o mesmo */}
                <Dialog>
                  <DialogTrigger asChild>
                   ...
                   <ToolDetailModal tool={tool} isDemoVideo={true} />
                </Dialog>
                
                {/* BOTÃO "Saiba mais" AGORA ABRE O MODAL DETALHADO */}
                <Dialog>
                    <DialogTrigger asChild>
